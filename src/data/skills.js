  ...
  categories: [
    {
      ...
      icon: "brain",
      skills: [
        { name: "LLMs", level: "expert", proficiency: "GPT-5 family, Claude, prompt engineering" },
        { name: "RAG Pipelines", level: "expert", proficiency: "Production retrieval systems" },
        { name: "Hybrid Retrieval", level: "expert", proficiency: "BM25 + FAISS, RRF fusion" },
        { name: "FAISS", level: "expert", proficiency: "Dense vector search (IVF)" },
        { name: "Vector Databases", level: "advanced", proficiency: "Indexing and ANN search" },
        { name: "Agentic Workflows", level: "advanced", proficiency: "Claude, OpenAI agent loops" },
        { name: "Multi-Tier Verification", level: "advanced", proficiency: "Draft / critique / escalate" },
        { name: "Langfuse", level: "advanced", proficiency: "LLM observability + cost tracing" },
        { name: "OpenAI API", level: "expert", proficiency: "Completions, embeddings, tools" },
        { name: "Prompt Engineering", level: "expert", proficiency: "Structured outputs + rubrics" },
