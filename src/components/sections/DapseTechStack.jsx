...
const STACK = [
  {
    ...
    items: [
      {
        name: "OpenAI GPT-5",
        role: "Three-tier model lineup",
        detail: "nano for verification, mini for prose, 5.1-chat as escalation",
        icon: Sparkles,
      },
      {
        name: "FastAPI",
        role: "Pipeline orchestration",
        detail: "Routes the request through ingest → retrieve → reason → render",
        icon: Brain,
      },
      {
        name: "FAISS",
        role: "Dense vector store (IVF)",
        detail: "Similarity search over 257K embedded chunks",
        icon: Network,
      },
      {
        name: "SQLite FTS5",
        role: "Lexical full-text search",
        detail: "Fused with FAISS via RRF, then authority-weighted reranking",
        icon: Search,
      },
      {
        name: "Self-correcting retrieval",
        role: "Low-confidence retry loop",
        detail: "nDCG@5 = 0.832 / Precision@5 = 0.954 on the hand-built eval suite",
        icon: Database,
      },
    ],
  },
